...
public class SpringBlogApplicationTests {
    ...
    public void setup() throws Exception{
        ...
        //Creates the test uer of not exists
        if(testUser == null){
            User newUser = new User();
            newUser.setUsername("testUser");
            newUser.setPassword(passwordEncoder.encode("pass")
            );
            newUser.setEmail("tesetUser@codeup.com");
            testUser = userDao.save(newUser);
        }

        //Throws a Post request to /login and expwct a redirection to the Posts index pafe after being loggin in
    ...
    public void testPostsIndex() throws Exception {
        ...
        this.mvc.perform(get("/posts"))
                ...
                .andExpect(content().string(containsString("Your posts:")))
                // Test the dynamic content of the page
